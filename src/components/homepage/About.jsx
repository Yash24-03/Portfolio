        ...
        <div className="top-20 sm:sticky md:top-28 lg:top-32 md:w-1/2">
          <div className="w-full space-y-4 2xl:space-y-10">
            ...
            <p ref={body} className=" translate-y-10 text-body-1 2xl:text-4xl opacity-0">
              I&apos;m an individual software developer from Himachal Pradesh , India
              <br></br>
              <br></br>As a freelancer, I provide robust digital solutions to clients, delivering high-quality results.📈
              <br></br>
              <br></br>
